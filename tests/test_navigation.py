...
class TestNavigation:
    ...
    def test_navigate_to_personal_account(self, driver, random_email, random_password):
    ...
    def test_navigate_to_constructor_from_profile(self, driver, random_email, random_password):
    # 1.Открыть главную страницу
        driver.get(BASE_URL)
    ...
    def test_navigate_to_constructor_via_logo(self, driver, random_email, random_password):
    # 1.Открыть главную страницу
        driver.get(BASE_URL)
