...
class TestLogin:
    ...
    def test_login_from_main_button(self, driver, random_email, random_password):
    ...
    def test_login_from_personal_account(self, driver, random_email, random_password):
    # 1.Открыть главную страницу
        driver.get(BASE_URL)
    ...
    # 7.Заполнить поле "Имя"
        driver.find_element(*input_name_register).send_keys("Михаоаилл")
    ...
    def test_login_from_register_page(self, driver, random_email, random_password):
    # 1.Открыть главную страницу
        driver.get(BASE_URL)
    ...
    def test_login_from_forgot_password(self, driver, random_email, random_password):
    # 1.Открыть главную страницу
        driver.get(BASE_URL)
